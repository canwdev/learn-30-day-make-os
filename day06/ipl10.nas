...
CYLS EQU 10      ; 定义一个常数代表 cylinders
...
DB "HARIBOTEOS   " ; 磁盘的名称（必须是11字节，不足填空格）
...
msg:
    ...
    DB 0
	  ...
	  RESB 0x7dfe-$		; 填充 0x00 至 0x7dfe 命令

	  DB 0x55, 0xaa           ; 一个扇区的最后两字节是55 AA的话，计算机就认为这个扇区的开头是启动程序，并开始执行这个程序